...
@section('this-page-contain')
    <div class="container-fluid px-4">
        <h1 class="mb-4">Edit Domisili</h1>
        ...
        <div class="bg-light p-2 mb-4 border rounded small">
            <span>Data Master / <a href="{{ route('master.domisili.index') }}"
                ...
                <span class="text-success fw-semibold">Edit</span></span>
        </div>

        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                <form action="{{ route('master.domisili.update', $domisili->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('wilayah') is-invalid @enderror" id="wilayah"
                                name="wilayah" value="{{ old('wilayah', $domisili->wilayah) }}" required>
                            @error('wilayah')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('daerah') is-invalid @enderror" id="daerah"
                                name="daerah" value="{{ old('daerah', $domisili->daerah) }}" required>
                            @error('daerah')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('entitas_daerah') is-invalid @enderror"
                                id="entitas_daerah" name="entitas_daerah" value="{{ old('entitas_daerah', $domisili->entitas_daerah) }}" placeholder="Contoh: KIP / dll">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('kamar') is-invalid @enderror" id="kamar"
                                name="kamar" value="{{ old('kamar', $domisili->kamar) }}" required>
                            @error('kamar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
