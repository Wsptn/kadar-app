...
@section('this-page-contain')
    <div class="container-fluid p-0">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h1 class="h3 mb-0">Edit Data Pendidikan</h1>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Edit Pendidikan</h5>
            </div>
                ...
                <form action="{{ route('master.pendidikan.update', $pendidikan->id_pendidikan) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_pendidikan"
                            ...
                            value="{{ old('nama_pendidikan', $pendidikan->nama_pendidikan) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan" rows="4" class="form-control @error('keterangan') is-invalid @enderror">{{ old('keterangan', $pendidikan->keterangan) }}</textarea>
