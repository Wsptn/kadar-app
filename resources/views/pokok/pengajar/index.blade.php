...
@section('this-page-contain')
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="mb-1">Data Pengajar</h2>
            </div>
        </div>

        {{-- Breadcrumb --}}
        <div class="bg-light p-2 mb-3 border rounded small">
            <span>Data Pokok / <span class="text-success fw-semibold">Pengajar</span></span>
        </div>

        {{-- Search Filter --}}
        <div class="card shadow-sm mb-4 border-0">
            <div class="card-body">
                <form action="{{ route('pokok.pengajar.index') }}" method="GET"
                    ...
                    @if (!empty($search))
                        <a href="{{ route('pokok.pengajar.index') }}" class="btn btn-secondary d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <div class="small text-success fw-bold mb-1" title="Fungsional Tugas">
                                        ...
                                        @php
                                            $ftPengajar = $p->fungsionalTugas->firstWhere('nama_tugas', 'Pengajar');
                                        @endphp
                                        @if ($ftPengajar)
                                            <span class="{{ $ftPengajar->pivot->status == 'non_aktif' ? 'text-decoration-line-through text-muted' : '' }}">
                                                {{ $ftPengajar->nama_tugas }}
                                            </span>
                                        @else
                                            -
                                        @endif
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-0">
                        <div class="card-body text-center py-5">
                            ...
                            <p class="text-muted mt-3 mb-0">Belum ada data Pengajar ditemukan.</p>
                        </div>
                    </div>
                </div>
            @endforelse
